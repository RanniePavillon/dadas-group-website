                    ...
                    <div class="container">
                        ...
                        <div id="navbarSupportedContent" class="collapse navbar-collapse">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a href="http://127.0.0.1:8000/contact" class="nav-link text-uppercase font-weight-bold" id="active">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
            ...
            <div class="col-sm-3 text-white">
                <h4>QUICK LINKS</h4>
                            <ul class="footerList">
                                ...
                                <li ><a href="http://127.0.0.1:8000/contact" class="footerLink" id="activeFooterLink">Contact</a></li>
                            </ul>
            </div>
            <div class="col-sm text-white">
                <h4>REACH US</h4>
